...
> React doesn't interact with the real DOM directly. It maintains a virtual DOM (tree of plain JS objects) and diffs it against the previous version, applying the minimum set of real DOM changes.
